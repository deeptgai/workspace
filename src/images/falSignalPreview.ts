...
export function buildSignalPreviewPrompt(signal: SnapshotSignal, options?: GenerateSignalPreviewOptions) {
  ...
  return [
    "Create a compact editorial thumbnail emblem for a Telegram mini-app signal card.",
    "No text, no letters, no logos, no UI screenshots.",
    "Style: premium tech media, clean abstract metaphor, sharp focal object, soft depth, usable as a card preview.",
