...
Главный критерий: каждый сигнал должен быть полезен подписчику или участнику группы. Ищи уникальное знание из этого канала: наблюдение, паттерн, прием, возможность, риск, контакт, контекст или вывод, который трудно получить без чтения этой ленты.
Не включай общеизвестные факты, справочные определения, случайные упоминания, пересказ поста или красивую формулировку без практической, стратегической, социальной или интеллектуальной пользы.
Если evidence слабое, одноразовое или не показывает значимость для читателя, лучше не добавлять item.
